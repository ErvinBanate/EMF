    ...
    <div class="pagetitle">
        ...
        <nav>
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">LogIn Page Maintenance</li>
            </ol>
        </nav>
    </div>
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-body">
                        <h2 class='text-center'>LogIn Page Background Image</h2>
                        <form action="{{ route('uploadLogIn', $backgroundImage[0]->id) }}" class="row mb-2" method="POST"
                                ...
                                <div class="image-preview-container">
                                    <div class="preview">
                                        <img id="preview-selected-image"
                                            src="{{ asset('Image/' . $backgroundImage[0]->img_url) }}"
                                            style="display:block" />
                                    </div>
