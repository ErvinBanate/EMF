    ...
    <div id="app">
        <nav class="navbar navbar-expand-md shadow-sm" style="background-color: maroon">
            <div class="container" id="navigation">
                ...
                <a class="navbar-brand" href="{{ url('/register') }}" style="color: white">Register New User</a>
                ...
                <a class="navbar-brand" href="{{ url('/adminInventoryRequest') }}" style="color: white">Inventory
                    Requests</a>
